...
class SolicitacaoDeEntrega extends BasePage implements HasForms
{
    ...
    protected string $view = 'filament.bydconquista.pages.solicitacao-de-entrega';

    protected static string $layout = 'filament.bydconquista.layout.base';
    ...
    public function submit()
    {
        ...
        $state['data']['empresa_id'] = Empresa::BYD_CONQUISTA_ID;
        ...
        $this->redirect('/bydconquista/solicitacao-de-entrega');
    }
}
