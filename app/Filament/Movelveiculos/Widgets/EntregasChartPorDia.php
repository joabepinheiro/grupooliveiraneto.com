...
class EntregasChartPorDia extends ChartWidget
{
    ...
    protected ?string $heading = 'Entregas finalizadas por dia';
    ...
    protected function getData(): array
    {
        ...
        $query = Entrega::query()
            ...
            ->selectRaw('DATE_FORMAT(DATE(entrega_efetivada_em), "%d/%m") as data')
            ->selectRaw('COUNT(*) as quantidade')
            ->groupByRaw('DATE(entrega_efetivada_em)')
