...
class SolicitacaoDeEntregaSeeder extends Seeder
{
    ...
    public function importarDadosDaMovelVeiculos(): void
    {
        ...
        try {
            $solicitacoesMovel= DB::connection('mysql_movelveiculos')
            ...
            foreach ($solicitacoesMovel as $solicitacao) {
                ...
                $novo = SolicitacaoDeEntrega::updateOrCreate([
                    ...
                    'vendedor_id'   => Mapeamento::getNovoId('users', $solicitacao->vendedor_id, 'movelveiculos'),
                    ...
                    'created_by'    => Mapeamento::getNovoId('users', $solicitacao->created_by, 'movelveiculos'),
                    'updated_by'    => Mapeamento::getNovoId('users', $solicitacao->updated_by, 'movelveiculos'),
                    'deleted_by'    => Mapeamento::getNovoId('users', $solicitacao->deleted_by, 'movelveiculos'),
